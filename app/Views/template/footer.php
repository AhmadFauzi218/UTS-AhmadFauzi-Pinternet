			...
			<div class="footer-grids">
				...
				<div class="col-md-3 footer-grid">
					<div class="footer-grid-left">
						<a href="single.html"><img src="<?= base_url(); ?>assets/images/10.jpg" alt=" " class="img-responsve" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="<?= base_url(); ?>assets/images/12.jpg" alt=" " class="img-responsve" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="<?= base_url(); ?>assets/images/11.jpg" alt=" " class="img-responsve" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="<?= base_url(); ?>assets/images/10.jpg" alt=" " class="img-responsve" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="<?= base_url(); ?>assets/images/8.jpg" alt=" " class="img-responsve" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="<?= base_url(); ?>assets/images/9.jpg" alt=" " class="img-responsve" /></a>
					</div>
...
<!-- for bootstrap working -->
	<script src="<?= base_url(); ?>assets/<?= base_url(); ?>assets/js/bootstrap.js"></script>
<!-- //for bootstrap working -->
</body>
</html>